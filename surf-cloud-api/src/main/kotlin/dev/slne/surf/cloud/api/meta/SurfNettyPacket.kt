...
object DefaultIds {
    ...
    const val CLOUD_REGISTER_SERVER_PACKET = 0x12
    const val CLOUD_SERVER_INFO_PACKET = 0x13
    const val CLOUD_SERVER_INFO_BATCH_PACKET = 0x14
    const val CONTAINER_POST_CONNECTED = 0x15
    const val CLIENT_JOIN = 0x16
    const val CLIENT_QUIT = 0x17
}
