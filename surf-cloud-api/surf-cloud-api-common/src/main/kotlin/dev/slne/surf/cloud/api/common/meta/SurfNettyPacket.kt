...
object DefaultIds {
    ...
    const val SERVERBOUND_REQUEST_CLOUD_SERVER_BY_ID = 0x39
    const val CLIENTBOUND_RESPONSE_CLOUD_SERVER = 0x3A
    const val SERVERBOUND_REQUEST_CLOUD_SERVER_BY_CATEGORY_AND_NAME = 0x3B
    const val SERVERBOUND_REQUEST_CLOUD_SERVER_BY_NAME = 0x3C

    const val SERVERBOUND_REQUEST_SERVERS_BY_CATEGORY = 0x3D
    const val CLIENTBOUND_RESPONSE_REQUEST_SERVERS_BY_CATEGORY = 0x3E
}
