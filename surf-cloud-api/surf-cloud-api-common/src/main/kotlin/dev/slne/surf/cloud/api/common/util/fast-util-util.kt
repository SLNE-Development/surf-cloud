...
fun <T> ObjectArrayList<T>.freeze(): @UnmodifiableView ObjectList<T> = ObjectLists.unmodifiable(this)
...
// region LongMap
// region Long2LongMap
fun mutableLong2LongMapOf(vararg pairs: Pair<Long, Long>) = Long2LongOpenHashMap(pairs.size).apply { putAll(pairs) }
...
fun <V> mutableInt2ObjectMapOf(vararg pairs: Pair<Int, V>) = Int2ObjectOpenHashMap<V>(pairs.size).apply { putAll(pairs) }
...
fun <V> Int2ObjectOpenHashMap<V>.freeze(): @UnmodifiableView Int2ObjectMap<V> = Int2ObjectMaps.unmodifiable(this)
// endregion
// region Object2IntMap
fun <K> mutableObject2IntMapOf(vararg pairs: Pair<K, Int>) = Object2IntOpenHashMap<K>(pairs.size).apply { putAll(pairs) }
...
fun <K> Object2IntOpenHashMap<K>.freeze(): @UnmodifiableView Object2IntMap<K> = Object2IntMaps.unmodifiable(this)
// endregion
// endregion