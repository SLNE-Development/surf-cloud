...
@SurfNettyPacket(
    DefaultIds.CLIENTBOUND_TITLE_PART_PACKET,
    PacketFlow.CLIENTBOUND,
    handlerMode = PacketHandlerMode.DEFAULT
)
class ClientboundSendTitlePartPacket(
    val uuid: UUID,
    ...
    companion object {
        val STREAM_CODEC = packetCodec(ClientboundSendTitlePartPacket::write, ::read)

        private fun read(buf: ByteBuf): ClientboundSendTitlePartPacket {
            ...
            return ClientboundSendTitlePartPacket(uuid, titlePart, value)
        }
    }
