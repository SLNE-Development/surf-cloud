...
@SurfNettyPacket(DefaultIds.CLIENTBOUND_PLAYER_LIST_HEADER_AND_FOOTER, PacketFlow.CLIENTBOUND)
class ClientboundSendPlayerListHeaderAndFooterPacket : NettyPacket {
    companion object {
        val STREAM_CODEC = packetCodec(
            ClientboundSendPlayerListHeaderAndFooterPacket::write,
