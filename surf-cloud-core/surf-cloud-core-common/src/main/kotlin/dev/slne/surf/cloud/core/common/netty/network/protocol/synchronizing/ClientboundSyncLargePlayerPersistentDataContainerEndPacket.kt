...
@SurfNettyPacket(
    "cloud:clientbound:sync_large_player_ppdc/end",
    PacketFlow.CLIENTBOUND,
    ConnectionProtocol.SYNCHRONIZING,
    handlerMode = PacketHandlerMode.NETTY
)
object ClientboundSyncLargePlayerPersistentDataContainerEndPacket : NettyPacket(),
    ...
    override fun handle(listener: ClientSynchronizingPacketListener) {
        listener.handleSyncLargerPlayerPersistentDataContainerEnd(this)
    }
}