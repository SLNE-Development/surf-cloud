...
@SurfNettyPacket(
    "cloud:clientbound:sync_players/end",
    PacketFlow.CLIENTBOUND,
    ConnectionProtocol.SYNCHRONIZING,
    handlerMode = PacketHandlerMode.NETTY
)
object ClientboundSyncPlayerHydrationEndPacket : NettyPacket(), InternalNettyPacket<ClientSynchronizingPacketListener> {
    val STREAM_CODEC = streamCodecUnitSimple(this)
    override fun handle(listener: ClientSynchronizingPacketListener) {
        listener.handleSyncPlayerHydrationEnd(this)
    }
}